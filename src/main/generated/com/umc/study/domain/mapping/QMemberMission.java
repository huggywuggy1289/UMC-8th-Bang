...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = 456848829L;
    ...
    public final com.umc.study.domain.QMember member;

    public final com.umc.study.domain.QMission mission;

    public final EnumPath<com.umc.study.domain.enums.MissionStatus> status = createEnum("status", com.umc.study.domain.enums.MissionStatus.class);
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new com.umc.study.domain.QMember(forProperty("member")) : null;
        this.mission = inits.isInitialized("mission") ? new com.umc.study.domain.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
